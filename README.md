...
> Building AI-powered services from idea to production
...
- **Language**: <img src="https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white"/> <img src="https://img.shields.io/badge/MySQL-4479A1?style=flat-square&logo=mysql&logoColor=white"/> <img src="https://img.shields.io/badge/PostgreSQL-4169E1?style=flat-square&logo=postgresql&logoColor=white"/>
...
- TTS / STT
- AI Service Planning & Development
<br>
...
- 젠디: 명리학 기반 사주 컨설팅 서비스
  - Prompt Engineering, 채팅 봇 메모리 관리 로직 연구
  - 상품 기획 및 데이터 분석 기반 UX 개선
- if (이프): 페르소나 AI 채팅 서비스
  - 아이돌 키우기: 성능 개선 지표 탐색, 기능 기획 및 개발
  - 캐릭터챗: 전 과정 기획, 지표 분석, 기능 기획 및 개발
- LLM Evaluation, SLM 사용 가능성 탐색

**FridaysLab** (Data Scientist) / 2022.5.9 ~ 2023.7.1
- Growth marketing, E-commerce data analysis
- Recommendation (Cross Selling, Next Basket Prediction)
- Code Optimization
<br>
...
Kaggle Profile: [SonChangYup](https://www.kaggle.com/SonChangYup)
